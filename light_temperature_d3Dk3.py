...
# Initial conditions
y0 = [0.85371592e+00, 0.72626332e+00, 5.01968466e-01, 6.46276320e-01,2.25236529e-01, 5.94439074e-01, 1.27049114e-02, 2.01664004e-02,0.5,(1+np.cos(5*np.pi/6))/2,0.355,10*np.cos(7*np.pi/6)+20,10]

# Parameter range for bifurcation analysis
k_deg_values = np.linspace(0, 0.4, 300)
initial_conditions1 = np.linspace(0, 0.4, 300)
