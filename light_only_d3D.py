# -*- coding: utf-8 -*-
"""
Created on Sun Jul 27 15:01:12 2025
...
# Initial conditions
# y0 = [0.85371592e+00, 0.72626332e+00, 5.01968466e-01, 6.46276320e-01,2.25236529e-01, 5.94439074e-01, 1.27049114e-02, 2.01664004e-02,0.5]
...
initial_conditions1 = np.linspace(0.5, 1.5, 100)
...
for i, y0_factor in enumerate(initial_conditions1):
    ...
    for j, k_deg in enumerate(k_deg_values):
        ...
        p2_values = sol.y[0]
        peaks, _ = find_peaks(p2_values[720:])
...
plt.ylabel('Scaling of the equilibrium $y_0$', fontdict=font)
...
# ax[0].set_ylabel('Scaling of the equilibrium $y_0$', fontdict=font)
# ax[0].set_title('Period', fontdict=font)
...
# ax[0].xticks(fontproperties = 'Times New Roman', size = 24)
# ax[0].yticks(fontproperties = 'Times New Roman', size = 24)
# plt.xlim([0,0.2])
# plt.ylim([0.5,1.5])
...
# ax[1].set_ylabel('Scaling of the equilibrium $y_0$', fontdict=font)
# ax[1].set_title('Phase', fontdict=font)
