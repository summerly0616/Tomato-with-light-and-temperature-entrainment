# -*- coding: utf-8 -*-
"""
Created on Tue Jul 29 19:48:43 2025
...
for k1L in k1L_values:
    sol = solve_ivp(tomato_circadian, [0, 120], [2.47371642, 2.90481064, 0.0123979,  0.02403111, 0.05779115, 0.08332316, 0.0117501,  0.00990988, 0.69341143], args=(k1L,), t_eval=np.linspace(0, 120, 1000))
...
plt.xlabel('$d_{3L}$',font)
plt.ylabel('$CL$ and $P51$ mRNA',font)
