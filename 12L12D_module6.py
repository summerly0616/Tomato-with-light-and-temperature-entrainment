...
def tomato_circadian(y,t):
    ...
    z=np.array([(v1+v1L*L*P)/(1+(CLp/K0)**2)-(k1L*L+k1D*D)*CLm,\
                (p1+p1L*L)*CLm-d1*CLp,\
...
y0 = [0.73504743, 1.13705128, 0.07109132, 0.07213094, 0.69340948]
...
plt.plot(t-72,yy1[:,0]-1.4,'k-',label='Continuous',linewidth=3)
plt.plot(t-72,yy2[:,0]-1.4,'b-',label='Discrete',linewidth=3)
