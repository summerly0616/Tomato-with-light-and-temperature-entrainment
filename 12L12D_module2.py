...
tspan=np.array([0,126]);
h=0.01
t=np.arange(tspan[0],tspan[1]+h,h)
y0 = [0.73504743, 1.13705128, 0.2264693,  0.38493123, 0.07109132, 0.07213094, 0.69340948]
...
# plt.plot(t-72,(yy1[:,2]-min(yy1[720:,2]))/(max(yy1[720:,2])-min(yy1[720:,2])),'k-',label='Continuous',linewidth=3)
# plt.plot(t-72,(yy2[:,2]-min(yy2[720:,2]))/(max(yy2[720:,2])-min(yy2[720:,2])),'b-',label='Discrete',linewidth=3)
...
# plt.plot(t-72,(yy1[:,4]-min(yy1[720:,4]))/(max(yy1[720:,4])-min(yy1[720:,4])),'k-',label='Continuous',linewidth=3)
# plt.plot(t-72,(yy2[:,4]-min(yy2[720:,4]))/(max(yy2[720:,4])-min(yy2[720:,4])),'b-',label='Discrete',linewidth=3)
